...
public class DefaultResourceAllocationStrategy implements ResourceAllocationStrategy {
    ...
    private static class InternalResourceInfo {
        ...
        boolean tryAllocateSlotForJobWithPreferredLocation(
            ...
            // BUGFIX: getEffectiveResourceProfile may return defaultSlotProfile by reference
            // (when requirement is UNKNOWN). Mutating it via setPreferredLocation would corrupt
            // the shared defaultSlotProfile and all previously stored allocationConsumer entries
            // that hold the same object reference. Always create a fresh copy.
            final ResourceProfile effectiveProfile =
